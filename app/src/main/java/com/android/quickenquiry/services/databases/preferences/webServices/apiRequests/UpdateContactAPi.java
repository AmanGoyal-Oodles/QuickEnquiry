...
public class UpdateContactAPi implements Callback<ResponseBody> {
    ...
    public UpdateContactAPi(Context context,AddContactAPIResponseListener listener,ProgressDialog progressDialog) {
        mContext=context;
        mAddContactAPIResponseListener=listener;
        mProgressDialog=progressDialog;
    }

    public void callAddContactApi(String userId,String contactId,String contactType,String contactRelation,String contactName,String contactMobile,String contactEmail,String contactAddress,String contactDOB,String contactAnniv) {
        ...
        Call<ResponseBody> call=userConnection.addContact(key,userId,contactId,contactType,contactRelation,contactName,contactMobile,contactEmail,contactAddress,contactDOB,contactAnniv);
        call.enqueue(this);
    }
